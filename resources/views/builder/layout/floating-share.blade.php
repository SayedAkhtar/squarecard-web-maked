...
<div class="share-buttons-container">
    <ul class="share-buttons--wrap">
        <li class="share-buttons--button" id="share-1">
            <a href="whatsapp://send?text=You are invited to our wedding. {{env('APP_URL').'/'.$user->UserURL}}" data-action="share/whatsapp/share" target="_blank">
                <img src="{{asset('img/buttons/whatsapp.png')}}" alt="" class="share-buttons--button--img" >
            </a>
        </li>
        <li class="share-buttons--button" id="share-2">
            <a href="https://www.facebook.com/sharer/sharer.php?u=www.squarecard.in/{{env('APP_URL').'/'.$user->UserURL}}/" class="social-media-button" target="_blank">    
...
$('#share-3').click(function(){
    if (navigator.share) {
      navigator.share({
          title: 'Wedding Card',
          text: 'You are Invited to the wedding.',
